    ...
    return (
        <main className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-24 px-6 pb-24 pt-12 sm:px-10 lg:px-16">
                ...
                <div className="flex flex-col gap-8">
                    <div className="space-y-4 text-left">
                        ...
                        <p className="max-w-xl text-base text-slate-200 sm:text-lg">
                            I build delightful products and research tooling that elevate Islamic
                            communities, creative professionals, and curious learners. Each project
                            blends inclusive design, robust engineering, and a relentless focus on
                            measurable impact.
                        </p>
                    </div>
            ...
            <section className="grid gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
                <div className="space-y-6">
                    ...
                    <p className="max-w-xl text-base text-slate-200/80">
                        From high-trust community platforms to experimental 3D experiences, I align
                        product vision with technical execution so that cross-functional teams can
                        move quickly without sacrificing craftsmanship.
                    </p>
                </div>
                ...
                <div className="space-y-4 text-center lg:text-left">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="mx-auto max-w-3xl text-base text-slate-200/80">
                            Ten of my most active projects—ranging from AI-assisted creative tooling
                            to community-first spiritual platforms—each with production-ready
                            deployments, automated testing, and thoughtful documentation.
                        </p>
                    </div>
                </div>
            ...
            <footer className="flex flex-col gap-3 border-t border-white/10 pt-8 text-sm text-slate-200/60 sm:flex-row sm:items-center sm:justify-between">
                <p>
                    © {currentYear} Ragaeeb Haq. Built with Next.js 16 and a passion for meaningful
